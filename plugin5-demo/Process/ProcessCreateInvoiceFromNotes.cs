...
{
    class ProcessCreateInvoiceFromNotes
    {

        private IHost Host;

        public void StartProcess(IHost host)
        {
            try
            {
                this.Host = host;
                ...
                List<long> lstNotes = new List<long> { 68922, 68927 };

                Aliquo.Core.Models.SalesInvoice salesInvoice = new Aliquo.Core.Models.SalesInvoice
                {
                    CustomerCode = "00025",
                    Notes = lstNotes,
                    Date = DateTime.Now
                ...
                this.Host.Documents.CreateSalesInvoiceAsync(salesInvoice);
